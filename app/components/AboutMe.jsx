    ...
    <div className="about-me-outer">
      <div className="about-me-background">
        <div className="center-contents">
          ...
          <h1>Contact Me</h1>
          <p>I absolutely love to hear from people!<br/><br/>Also head over to my photo blog on Instagram, @code.ess, where I visually document my trials and tribulations--and sometimes the occasional coding meme.</p>
        </div>
      </div>
    </div>
    <footer>
